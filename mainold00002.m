...
trainFromSratch=0;
showSample=true;
[frcnndetector,roi,bboxes]=FRCNN(tb,lgraph,trainFromSratch,showSample);
...
% dlXGeneratedNew = predict(Generator,dlZNew);
% 
% 
% genImages = extractdata(dlXGeneratedNew);
...
acc1=Result1.Accuracy;
pre1=Result1.Precision;
re1=Result1.Sensitivity;
f1=Result1.F1_score;
y=[acc1,pre1,re1,f1];

% save m1.mat acc1 pre1 re1 f1 
figure;
heatmap(c_matrix1);
xlabel('Actual class')
